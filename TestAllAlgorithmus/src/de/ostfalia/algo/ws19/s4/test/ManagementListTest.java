...
public class ManagementListTest {
	 ...
	 * 		Nach dem Aufrufen des Standard-Konstruktors duerfen sich keine Datensaetze
	...
	public void testKonstruktorEinDatensatz() throws IOException {
		...
		IManagement mgnt = new ManagementList(Arrays.copyOf(data10, 1));
		evaluate(mgnt, 0);		
	}
	...
	public void testKonstruktorZehnDatensaetze() throws IOException {
		trace.add("Konstruktoraufruf Management(String[]).");
		IManagement mgnt = new ManagementList(data10); 
		evaluate(mgnt, all);		
	}
